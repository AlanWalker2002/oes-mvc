				...
				<div class="col-4">
					<div class="page-title-box">
						<div class="page-title-left">
							<a class="title btn btn-success me-4" href="index.php?action=export_score&test_code=<?= $scores[0]->test_code ?>">Xuất File Excel</a>
					...
					<div class="card">
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-centered table-striped dt-responsive nowrap w-100" id="scores">
									<thead>
										<tr>
											<th>ID</th>
											<th>Tên Học Sinh</th>
