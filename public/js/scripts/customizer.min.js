...
$(document).ready(function () {
    $('.theme-cutomizer').sidenav({ edge: 'right' });
    new PerfectScrollbar('.theme-cutomizer', { suppressScrollX: !0 });
    function r(e) {
        e
            ? ($('.menu-dark-checkbox').prop('checked', !0),
              $('.sidenav-main')
                  .removeClass('sidenav-light')
                  .addClass('sidenav-dark'))
            : ($('.menu-dark-checkbox').prop('checked', !1),
              $('.sidenav-main')
    ...
    function a(e) {
        e
            ? ($('.sidenav-main').removeClass('nav-lock'),
              ...
              $(
                  '.sidenav-main.nav-collapsible, .navbar .brand-sidebar'
              ).trigger('mouseleave'))
            : ($('.sidenav-main')
                  .addClass('nav-lock')
    ...
    function o(e) {
        d('.navbar-main'),
            e
                ? ($('.navbar-dark-checkbox').prop('checked', !0),
                  $('.navbar-main')
                      .removeClass('navbar-light')
                      .addClass('navbar-dark'))
                : ($('.navbar-dark-checkbox').prop('checked', !1),
                  $('.navbar-main')
    ...
    function n(e) {
        e
            ? ($('.footer-dark-checkbox').prop('checked', !0),
              $('.page-footer')
                  .removeClass('footer-light')
                  .addClass('footer-dark'))
            : ($('.footer-dark-checkbox').prop('checked', !1),
              $('.page-footer')
    ...
    $('body').hasClass('vertical-menu-nav-dark')
        ...
        ? ($('.menu-color').hide(), (menuBgDefault = !0))
        : $('body').hasClass('horizontal-menu') && $('.menu-options').hide(),
        $('.menu-color-option, .menu-bg-color-option').click(function (e) {
            $(
                '.menu-color .menu-color-option, .menu-bg-color .menu-bg-color-option'
            ...
            menuBgDefault
                ? (r(!0),
                  (n = o),
                  d('.sidenav-main'),
                  $('.sidenav-main').addClass(n + ' sidenav-gradient'))
                : ((a = o),
                  ...
                  $('.sidenav-main .sidenav li a.active').addClass(
                      a + ' gradient-shadow'
                  ));
        }),
        ...
        $('.navbar-fixed-checkbox').click(function (e) {
            $('.navbar-fixed-checkbox').prop('checked')
        ...
        $('.footer-fixed-checkbox').click(function (e) {
            $('.footer-fixed-checkbox').prop('checked')
                ? $('.page-footer')
        ...
        0 < $("html[data-textdirection='rtl']").length &&
            $('.theme-cutomizer').sidenav({ edge: 'left' });
});
